...
XToolButton::XToolButton(const QString& path, QWidget *parent)
 ...
 */
void XToolButton::doPaintStuff(int topColor, int centerColor, int bottomColor)
{
...
void XToolButton::setButtonPressed(bool isPressed)
{
